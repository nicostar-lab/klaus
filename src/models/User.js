...
const userSchema = new mongoose.Schema(
  {
    ...
    telephone: {
      ...
      trim: true,
      match: [/^(228)?\d{8}$/, "Le numéro doit contenir 8 à 11 chiffres"],
    },
    ...
    biographie: {
      ...
      default: "Salut, je suis un utilisateur de SameWay !",
    },
...
// ============================================
// L'index email est déjà créé via `unique: true` sur le champ `email`.
// Pour éviter le warning Mongoose (index dupliqué), ne pas redéfinir
// explicitement un index ici.
